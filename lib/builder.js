...
Builder.prototype.buildAdd = function (lhs, rhs, name) {
  return Library.LLVMBuildAdd(this.ptr, lhs, rhs, name)
}
Builder.prototype.buildSub = function (lhs, rhs, name) {
  return Library.LLVMBuildSub(this.ptr, lhs, rhs, name)
}
